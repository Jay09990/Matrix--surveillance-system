...
import { AddCameraForm } from '../features/cameras/AddCameraForm';
      ...
      <main className="flex-1 overflow-y-auto p-6 lg:p-10">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="flex items-center mb-8 pb-4 border-b border-[#2a2a2a]">
            ...
            <div>
              <h1 className="text-2xl font-bold tracking-tight text-white mb-1">Add Camera</h1>
              <p className="text-[#8d90a0] text-sm">Assign a new camera to an NVR channel.</p>
            </div>
          </div>
